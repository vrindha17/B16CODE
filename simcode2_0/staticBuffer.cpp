...
int StaticBuffer::getFreeBuffer(int blockNum){
    ...
    if(bufferIndex == -1){
        ...
        //TODO: Verify if this is needed... updating the blockAllocnMap also back to block when replacement algorithm is done;
        //There is a difficulty than only 1 bit in the blockallocn map in the block has to be changed. But updateion can be only done to a block altogether.
